...
import {
  ...
  AdaptableOptions,
  AdaptableReadyInfo,
} from "@adaptabletools/adaptable-react-aggrid-cjs";
...
const Adaptabletestgrid = () => {
  ...
  const adaptableOptions: AdaptableOptions<any> = {
    primaryKey: "id",
    adaptableId: "Select Editors",
    userInterfaceOptions: {
      editLookUpItems: [
        {
          scope: { ColumnIds: ["license", "language"] },
        },
      ],
    },
    predefinedConfig: {
  ...
  const columnDefs: any[] = [
    ...
    { field: "has_wiki", headerName: "Has Wiki", type: "abColDefBoolean" },
    {
      field: "updated_at",
      headerName: "Updated",
      type: "abColDefDate",
  ...
  const onAdaptableReady = ({ adaptableApi }: AdaptableReadyInfo) => {
  ...
  // const [adaptOptions, setAdaptOptions] = useState<AdaptableOptions<any>>({
  //   ...adaptableOptions,
  //   stateOptions: {
...
export default Adaptabletestgrid;
